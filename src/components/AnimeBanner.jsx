...
export default function AnimeBanner({ anime }) {
  return (
    <div className='relative flex flex-col items-center gap-6 justify-center h-[300px] lg:h-[400px] mt-16 lg:mt-0'>
      ...
      <img src={anime?.images?.webp?.large_image_url} alt={anime?.title_english} className='absolute inset-0 -z-10 blur-md object-cover w-full h-[300px] lg:h-[400px] select-none' />
