    ...
    <form onSubmit={onSubmit} className='bg-primary-foreground mx-auto md:mx-0 w-full xl:w-fit flex items-center border border-neutral-700 rounded-full'>
      <div className='relative grow'>
        ...
        <Input
          ...
          value={searchValue}
          placeholder='Search'
          className='rounded-none text-sm h-10 w-full xl:w-fit lg:min-w-[275px] pl-12 bg-white dark:bg-black/30 md:rounded-full border-none focus:outline-none focus:ring-0 focus:ring-transparent focus:ring-offset-0'
        />
        {searchValue && (
          <Button
