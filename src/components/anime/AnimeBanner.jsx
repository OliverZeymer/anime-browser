...
export default function AnimeBanner({ anime }) {
  ...
  return (
    <div className='relative flex flex-col items-center gap-3 md:gap-6 justify-center md:h-72 xl:h-96 mt-16 lg:mt-0'>
      ...
      <img src={anime?.images?.webp?.large_image_url} alt={anime?.title_english} className='absolute inset-0 -z-10 blur-md object-cover w-full opacity-25 md:opacity-100 md:h-72 xl:h-96 select-none' />
