...
function ResultsList({ results, selectedIndex, searchValue }: ResultsListProps) {
  return (
...
export default function SearchModalResults({ results, selectedIndex, hasSearched, searchValue }: Props) {
  if (results?.length === 0) {
