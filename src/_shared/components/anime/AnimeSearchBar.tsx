...
export default function AnimeSearchBar({ order, status, search, type, genres }: Props) {
  ...
  return (
    <form key={search} onSubmit={onSubmit} className='bg-primary-foreground mx-auto md:mx-0 w-full xl:w-fit flex items-center border border-neutral-700 rounded-full'>
